...
export namespace Prisma {
  ...
  */
  ...
  interface cinemaFieldRefs {
    ...
    readonly image: FieldRef<'cinema', 'String'>;
  ...
  export type cinemaWhereInput = {
    ...
    image?: StringNullableFilter<'cinema'> | string | null;
  ...
  export type cinemaScalarWhereWithAggregatesInput = {
    ...
    image?: StringNullableWithAggregatesFilter<'cinema'> | string | null;
