...
import { useCinemaFindFirst, useRoqClient } from 'lib/roq';

import { CinemaInterface } from 'interfaces/cinema';

function CinemaViewPage() {
  ...
  const { data, error, isLoading } = useCinemaFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('cinema', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/cinemas/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="cinema" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
